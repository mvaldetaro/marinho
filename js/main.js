  ...
  (function () {
    ...
    $(document).ready(function(e) {
      ...
      $(document).scroll(function(){
        var top = $('#competencias').height()-$(window).scrollTop();
        if(top<-300){
          if(index==0){
    ...
    function showSWF(urlString, elementID){
        ...
        var flash = createSWFObject(urlString, 'opaque', 800, 600);
    ...
    if (!isMobile) {
      showSWF('flash/multiflex.swf', 'nationwide');
      showSWF('flash/inb.swf', 'inb');
      showSWF('flash/itaipu.swf', 'itaipu');
      showSWF('flash/cef.swf', 'cef');
    }
  }());
}
main();
